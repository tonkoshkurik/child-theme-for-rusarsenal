...
document.addEventListener("DOMContentLoaded", function()
	{
            var navList = document.querySelectorAll('#main-menu>li.nav-item');
            
            for (var i=0; i<navList.length; i++){
                if(!navList[i].classList.contains('active')){
                    navList[i].addEventListener('mouseover', function(event){
                        event.currentTarget.classList.add('active', 'open');
                    });
                    navList[i].addEventListener('mouseout', function(event){
                        event.currentTarget.classList.remove('active', 'open');
                    });
                }
            }
            var catParent = document.querySelectorAll('.cat-parent');
            ...
            if(catParent){
            	...
            	for(i=0; i<catParent.length; i++){
            		catA[i] = catParent[i].querySelector('a');
            		catA[i].innerHTML += ' <i class="fa fa-plus-circle" aria-hidden="true"></i>';
            		catA[i].href = "#";
            		catA[i].addEventListener('click', function(event){ event.preventDefault(); })
            		catParent[i].addEventListener('click', 
            			function(event){
		            		var elem = event.currentTarget;
		            		var evTarget = event.target;
		            		// if (!elem.classList.contains('cat-parent')){  console.log(this); };
		            		elem.classList.toggle('opened');
		            		var ai = elem.querySelector('a i');
		            		if (ai.classList.contains('fa-plus-circle')){ 
								ai.classList.remove('fa-plus-circle');
		            			ai.classList.add('fa-minus-circle');
		            		} else {
		            			ai.classList.remove('fa-minus-circle');
		            			ai.classList.add('fa-plus-circle');
		            		}

		            		// event.preventDefault();
							// event.stopPropagation();
		    			});
            		cataLi[i] = catParent[i].querySelectorAll('ul.children li.cat-item');
            		for(j=0; j<cataLi[i].length; j++){
            			cataLi[i][j].addEventListener('click', function(e){
            				if(this.classList.contains('cat-parent')){
            					e.preventDefault();
            				}
            				e.stopPropagation();})	
            		}
              ...
              var open = false;
			  var opener = document.querySelector('#habla_oplink_a');
			  var habla_expanded_div = document.querySelector('#habla_expanded_div');
			  var habla_icon = document.querySelector('i.fa.fa-arrow-circle-up');
			  opener.addEventListener( "click" , function(event) {
			  		event.preventDefault();
			  		event.stopPropagation();
			  		event.stopImmediatePropagation();
			      if(open){
			        habla_expanded_div.style.display = "none";
			        habla_icon.classList.remove("fa-arrow-circle-down");
			        habla_icon.classList.add("fa-arrow-circle-up");
			        open = false;
			      } else{
			        habla_expanded_div.style.display = "block";
			        habla_icon.classList.remove("fa-arrow-circle-up");
			        habla_icon.classList.add("fa-arrow-circle-down");
			        open = true;
			      }
			  });
	});
...
setupAsync({"key":undefined,"apikey":undefined,"browser":{"name":"Firefox","version":"47.0","engine":"Gecko","engineVersion":"47.0","osName":"Ubuntu","osFamily":"Linux","isMobile":false,"cssPrefix":"Moz","webglBlacklisted":false},"lang":"ru_RU","languageCode":"ru","countryCode":"RU","hosts":{"api":{"main":"//api-maps.yandex.ru/","ua":"//legal.yandex.ru/maps_termsofuse/?lang={{lang}}","maps":"https://maps.yandex.ru/","statCounter":"https://clck.yandex.ru/","services":{"coverage":"https://api-maps.yandex.ru/services/coverage/","geoxml":"https://api-maps.yandex.ru/services/geoxml/","route":"https://api-maps.yandex.ru/services/route/","regions":"https://api-maps.yandex.ru/services/regions/","geocode":"//geocode-maps.yandex.ru/","suggest":"//suggest-maps.yandex.ru/","search":"https://api-maps.yandex.ru/services/search/","inception":"https://api-maps.yandex.ru/services/inception/"}},"layers":{"map":"//vec0%d.maps.yandex.net/tiles?l=map&%c&%l","sat":"//sat0%d.maps.yandex.net/tiles?l=sat&%c&%l","skl":"//vec0%d.maps.yandex.net/tiles?l=skl&%c&%l"},"panoramasApi":"https://panoramas.api-maps.yandex.ru/","traffic":"//jgo.maps.yandex.net/","trafficArchive":"//jft.maps.yandex.net/"},"layers":{"map":{"version":"4.84.0","scaled":true},"sat":{"version":"3.265.0"},"skl":{"version":"4.84.0","scaled":true},"trf":{"version":"1465675233","scaled":true}},"geolocation":{"longitude":31.482771,"latitude":49.02753,"isHighAccuracy":false,"span":{"longitude":18.090408,"latitude":7.214737}},"token":"aab51e563cb5516560323e7e64f2eb8b","sign":(function(r){function t(e){if(n[e])return n[e].exports;var o=n[e]={exports:{},id:e,loaded:!1};return r[e].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=r,t.c=n,t.p="",t(0)})([function(r,t,n){"use strict";function e(){for(var r=["4","1","d","c","d","0","f","c","2","5","e","3","a","6","d","2","4","2","0","d","9","5","8","7","9","e","f","b","b","4","9","7","6","7","2","c","b","6","8","e"],t=[[DOMException.NAMESPACE_ERR-6,document.createTextNode("Gan.").nodeName.length+32],[SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMAX+2,SVGTransform.SVG_TRANSFORM_SCALE+27],[SVGAngle.SVG_ANGLETYPE_UNSPECIFIED+8,DOMException.HIERARCHY_REQUEST_ERR+4]],n=0;n<t.length;n++){var e=t[n][0],o=t[n][1],i=r[e];r[e]=r[o],r[o]=i}return r.join("")}var o,i=n(1),u=n(2);r.exports=function(r){return o||(o=i(e())),i(u(r),o)}},function(r,t){"use strict";r.exports=function(r,t){t=t||0;for(var n=0;n<r.length;n++)t+=(t<<1)+(t<<4)+(t<<7)+(t<<8)+(t<<24),t^=r.charCodeAt(n);return t>>>0}},function(r,t){"use strict";r.exports=function(r){r=r.replace(/^.*\/\//,"");var t=r.indexOf("?");if(-1===t)return r;var n=t+1,e=r.indexOf("#",n);-1===e&&(e=r.length);var o=r.substring(n,e).split("&",1e3);return r.substring(0,n)+o.sort().join("&")+r.substring(e)}}]),"distribution":{},"version":"2.1.41","majorVersion":"2.1","cssPrefix":"ymaps-2-1-41-","server":{"url":"//api-maps.yandex.ru/2.1.41","path":"./build/release/","params":{},"version":1465307629283},"preload":{"load":"package.full"},"coordinatesOrder":"latlong"});})(this);
    ...
    function init(){     
        myMap = new ymaps.Map("ya_map", {
            center: [59.985989, 30.516686],
            zoom: 15,
            controls: ['smallMapDefaultSet']
        });
            myPlacemark = new ymaps.Placemark([59.985989, 30.516686], { 
            hintContent: 'ООО «РУСАРСЕНАЛ-СПб»', 
            balloonContent: '' 
        });
        myMap.balloon.open(myMap.getCenter(),
            {
                contentHeader: 'ООО «РУСАРСЕНАЛ-СПб» ',
                contentBody: '195043 г. Санкт-Петербург, <br>Рябовское шоссе, д.124 </p><p><a href="tel:88123134326">8 (812) 313-43-26</a><br><a href="tel:>89013018630">8 (901) 301-86-30 </a><br><a href="mailto:info@rusarsenal-spb.com">info@rusarsenal-spb.com</a></p>',
            }
        );
